...
export default function Home() {
    ...
    const DownloadButton = () => {
        ...
        if (isMobile) {
            return (
                <a
                    href="/KubanHistory.apk" // Путь к файлу в /public
                    download // Этот атрибут указывает браузеру скачать файл
                    className="flex items-center justify-center text-sm px-3 py-2 bg-amber-600 text-white rounded-lg hover:bg-amber-700 transition-colors h-10"
                >
        ...
        return (
            <Link
                href="/download"
                className="flex items-center px-4 py-2 bg-amber-600 text-white rounded-md hover:bg-amber-700 transition-colors h-10 md:h-12"
            >
    ...
    return (
        <div className="min-h-screen bg-amber-50">
            <div className="bg-amber-100 py-4 px-4 border-b border-amber-200 sticky top-0 z-20">
                <div className="container mx-auto flex justify-between items-center">
                    ...
                    {/* ✅ ИЗМЕНЕНИЕ: Просто вызываем компонент DownloadButton.
                        Он сам решит, что показать (или не показать ничего).
                        Flexbox `justify-between` автоматически прижмет его к правому краю. */}
                    <DownloadButton />
            ...
            <div className="container mx-auto px-4 py-8 max-w-6xl">
                ...
                {/* ✅ ИЗМЕНЕНИЕ: Кнопка для мобильных была УДАЛЕНА ОТСЮДА и перемещена в шапку. */}
